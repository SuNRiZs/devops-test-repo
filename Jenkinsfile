        ...
        stage('Deploy to server') {
            steps {
                ...
                sh """
                    ...
                    sed -i "s/image: sunraize\\/test-php:.*/image: sunraize\\/test-php:${BUILD_NUMBER}/" /home/devops/docker-compose.yml && \
                    mkdir -p /home/devops/data && \
                    docker-compose -f /home/devops/docker-compose.yml pull && \
                    docker-compose -f /home/devops/docker-compose.yml up -d && \
                    docker exec mysql_container mysql -u root -p root test_zadanie < /home/devops/database/create-blog-and-comments-tables.sql
                """
            }
        }
